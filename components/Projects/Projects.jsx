...
const PROJECTS = [
  {
    ...
    kind: "Live App",
    note: "AI-powered, role-based civic grievance routing platform (Citizen / Department Admin / Super Admin) with photo and geolocation evidence, automated classification via LLM & OCR, and JWT security with brute-force lockout protection.",
  },
  {
    name: "BioFactor Pulse",
    href: "https://intern-mu-one.vercel.app",
    github: "https://github.com/harshithachodey05-hub/intern",
    role: "React.js • REST APIs • RBAC • Field Operations Platform",
    kind: "Live App",
...
const VENTURES = [
  {
    ...
    href: "https://intern-mu-one.vercel.app",
    kind: "Capability",
    note: "Multi-role enterprise platforms with Role-Based Access Control (RBAC), robust authentication, and high-concurrency client state.",
  },
  {
